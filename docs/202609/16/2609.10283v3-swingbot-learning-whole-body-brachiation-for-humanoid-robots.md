...
date: 2026-09-09
pdf: "https://arxiv.org/pdf/2609.10283v3"
tags: ["query:q4"]
score: 7.0
evidence: 类人机器人的全身运动规划
tldr: SwingBot是一个为高自由度人形机器人设计的全身体操（臂行）学习框架。针对臂行中复杂的释放-摆动-抓取序列及接触状态感知难题，该研究通过引入仿生关键帧引导探索，并结合循环特权状态估计实现鲁棒控制。实验证明，该方法使机器人能够实现连续的横杆穿越，并具备应对负载变化和外部干扰的能力，为复杂环境下的机器人移动提供了新方案。
selection_source: fresh_fetch
motivation: 旨在解决人形机器人在复杂或受限环境中缺乏高效臂行移动能力的问题。
method: 采用基于仿生关键帧的强化学习策略，并结合循环特权状态估计来处理不确定接触与运动控制。
result: 成功实现了人形机器人在硬件上的连续横杆穿越，并表现出对不同间距、负载及干扰的鲁棒性。
conclusion: SwingBot为高自由度机器人实现全身体操运动提供了一种实用且高效的训练范式。
---

...
score: 7.0
evidence: 机器人操作的强化学习
tldr: 针对机器人操作任务中强化学习训练不稳定的问题，本文提出D-SPEAR框架。该框架通过解耦Actor和Critic的经验回放策略，使Critic利用优先采样提高学习效率，而Actor利用低误差样本稳定策略优化。结合自适应锚点机制和Huber损失函数，D-SPEAR在robosuite基准测试中显著提升了SAC和TD3等算法的性能与稳定性。
...
conclusion: 通过针对性地优化Actor和Critic的数据采样策略，可以有效解决强化学习在机器人操作中的训练不稳定问题。
---

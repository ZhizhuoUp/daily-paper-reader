...
tldr: MetaTune是一个用于机器人控制器和扰动观测器联合自动调优的框架。它结合了可微动力学和伴随方法，通过元学习实现自适应增益调整。该方法将梯度计算复杂度降低至线性，在四旋翼无人机实验中显著提升了跟踪精度和抗干扰能力，并具备良好的零样本迁移能力。
selection_source: fresh_fetch
motivation: 针对机器人系统中控制器增益与扰动观测器参数耦合导致的调优难题，寻求一种高效的自动调优方案。
method: 提出MetaTune框架，利用可微系统动力学和伴随方法高效计算元梯度，实现反馈控制器与观测器的联合优化。
result: "实验表明该方法比现有技术减少了50%以上的梯度计算时间，并在高保真仿真中降低了高达40%的跟踪误差。"
conclusion: MetaTune通过结合物理信息梯度与元学习，为复杂动态环境下的机器人鲁棒控制提供了一种高效且通用的调优手段。
---

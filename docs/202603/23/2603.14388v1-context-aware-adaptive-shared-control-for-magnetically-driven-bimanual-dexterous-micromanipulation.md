...
tldr: 针对磁驱动微型机器人在复杂血管环境中双臂协同操作的高认知负荷问题，本文提出Bi-CAST框架。该框架通过多模态网络融合视觉特征与空间风险指标，实时动态调整双臂控制权重，并结合双向触觉反馈实现人机意图协作。实验表明，该方法在血管模型导航中显著降低了碰撞率和操作负荷，提升了轨迹平滑度与任务效率。
selection_source: fresh_fetch
motivation: 磁驱动双臂微操纵在复杂通道中虽具灵活性，但其非线性动力学和协同需求给操作者带来了极高的认知负担。
method: 提出Bi-CAST框架，利用多模态网络实时调节控制权，并结合触觉反馈接口实现基于意图识别的人机动态协作。
result: "实验显示该框架减少了76.6%的碰撞，降低了44.4%的工作负荷，并实现了最快的任务完成时间。"
conclusion: 上下文感知的自适应共享控制能有效优化双臂磁控微操纵性能，在降低操作难度的同时显著提高复杂环境下的作业安全性。
---

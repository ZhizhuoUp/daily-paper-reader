...
tldr: 针对人机交互环境中自主机器人的伦理决策挑战，本文提出一种实时神经符号伦理管理器。该框架结合了基于Transformer的伦理推理与概率伦理风险场，通过微调DistilBERT模型从自然语言中推断伦理意图，并利用阈值覆盖机制实现安全控制。实验证明，该方法在不降低任务效率的前提下，显著提升了机器人操作的安全性、风险辨识力与决策透明度。
selection_source: fresh_fetch
motivation: 旨在解决自主机器人在人类中心和安全敏感环境中缺乏实时伦理风险评估与动态安全干预机制的问题。
method: 提出一种集成DistilBERT伦理推理、概率风险场建模及阈值覆盖控制的神经符号架构，实现从语言描述到安全动作的映射。
result: 仿真实验表明，该系统能有效识别伦理风险并实现稳定收敛，在保障安全决策的同时未显著降低任务执行效率。
conclusion: 神经符号架构为自主机器人提供了兼具可解释性与实时性的伦理监督层，在辅助机器人及物理信息系统领域具有广泛应用潜力。
---

...
tldr: 该研究提出了一种基于前向不变性诱导动作空间设计的安全强化学习框架。与传统的运行时屏蔽或惩罚机制不同，该方法将安全性直接嵌入动作表示中，通过构建由稳定反馈控制律组成的有限动作集，确保每个动作都能维持安全状态集的前向不变性。这使得智能体在“结构安全”的策略类中进行优化，实现了安全保障与性能优化的解耦，并在四旋翼无人机仿真中验证了其有效性。
selection_source: fresh_fetch
motivation: 旨在解决传统安全强化学习中安全性与性能优化耦合、且难以在非线性系统中提供严格安全保障的问题。
method: 通过设计一个由多个能保持前向不变性的稳定反馈控制律组成的有限动作空间，使智能体在结构安全的策略类中进行学习。
result: 在四旋翼无人机悬停调节任务中，该方法在保证所有策略绝对安全的前提下，显著提升了闭环性能和切换效率。
conclusion: 该框架成功实现了安全保障与性能优化的解耦，为非线性系统的安全强化学习提供了一种具有理论保障的新思路。
---

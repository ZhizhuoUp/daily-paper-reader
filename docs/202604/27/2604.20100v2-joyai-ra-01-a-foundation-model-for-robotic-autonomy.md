...
tldr: JoyAI-RA是一个针对通用机器人操作的视觉-语言-动作（VLA）具身大模型。针对现有机器人数据规模有限且跨具身泛化难的问题，该模型提出了多源多层级预训练框架，整合了互联网数据、人类操作视频、仿真及真实机器人轨迹。通过统一动作空间，JoyAI-RA有效弥合了人类与机器人间的具身差异，在仿真和真实世界基准测试中均表现出卓越的泛化能力。
selection_source: fresh_fetch
motivation: 开放世界中的机器人自主性受限于数据多样性不足以及跨具身泛化能力差的问题。
method: 提出一种多源多层级预训练框架，通过统一动作空间整合互联网、人类视频、仿真和真实机器人数据。
result: JoyAI-RA在仿真和真实世界的多样化任务基准测试中均优于现有最先进的方法。
conclusion: 该研究证明了通过多源数据融合与动作空间统一构建具身大模型是提升机器人通用操作能力的有效途径。
---

## 摘要
开放世界环境中的机器人自主性从根本上受到数据多样性不足和跨具身泛化能力差的限制。现有的机器人数据集通常在规模和任务覆盖范围上有限，而不同机器人具身之间的较大差异阻碍了有效的行为知识迁移。为了应对这些挑战，我们提出了 JoyAI-RA，这是一种专为可泛化机器人操纵量身定制的视觉-语言-动作（VLA）具身基础模型。JoyAI-RA 提出了一个多源多层级的预训练框架，整合了网络数据、大规模第一人称视角人类操纵视频、仿真生成的轨迹以及真实机器人数据。通过在具有显式动作空间统一的异构多源数据上进行训练，JoyAI-RA 有效地弥合了具身差距，特别是人类操纵与机器人控制之间的差距，从而增强了跨具身行为学习。JoyAI-RA 在仿真和真实世界基准测试中均优于现有最先进的方法，特别是在具有泛化需求的多样化任务上。
